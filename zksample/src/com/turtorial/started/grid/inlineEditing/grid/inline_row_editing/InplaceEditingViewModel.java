...
import com.turtorial.started.grid.inlineEditing.data.ContributorData;
...
public class InplaceEditingViewModel {
	...
	private final List<LanguageContributionStatus> contributionStatuses = generateStatusList(contributorData.getLanguageContributors());
	...
	public void changeEditableStatus(@BindingParam("languageContributionStatus") LanguageContributionStatus lcs) {
		System.out.println(lcs.getEditingStatus());
		LanguageContribution lc=lcs.getLanguageContribution();
		System.out.println(lc.getCharset());
